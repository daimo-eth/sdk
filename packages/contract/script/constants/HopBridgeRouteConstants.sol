    ...
    )
{
    ...
    if (sourceChainId == 10) {
        ...
        finalChainCoins[1] = DaimoPayHopBridger.FinalChainCoin({
            ...
            coinDecimals: getHopCoinDecimals(0x2a22f9c3b484c3629090FeED35F17Ff8F88f76F0)
        });
    ...
    if (sourceChainId == 56) {
        ...
        finalChainCoins[1] = DaimoPayHopBridger.FinalChainCoin({
            ...
            coinDecimals: getHopCoinDecimals(0x754704Bc059F8C67012fEd69BC8A327a5aafb603)
        });
