...
import {DEPLOY_SALT_STARGATE_USDC_BRIDGER} from "../DeploySalts.sol";

contract DeployDaimoPayStargateUSDCBridger is Script {
    function run() public {
        (
        ...
        console.log(
            "Stargate USDC bridger deployed at address:",
            address(bridger)
        );
    }
