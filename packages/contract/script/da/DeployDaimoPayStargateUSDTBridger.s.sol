...
import {DEPLOY_SALT_STARGATE_USDT_BRIDGER} from "../DeploySalts.sol";

contract DeployDaimoPayStargateUSDTBridger is Script {
    function run() public {
        (
        ...
        console.log(
            "Stargate USDT bridger deployed at address:",
            address(bridger)
        );
    }
