...
// @title DACCTPV2BridgeRouteConstants
// @notice Auto-generated DA constants for CCTP V2 bridge routes

// Return all DA CCTP V2 bridge routes for the given source chain.
function getDACCTPV2BridgeRoutes(
    ...
    )
{
    ...
    if (sourceChainId == 1) {
        ...
        bridgeRoutes = new DaimoPayCCTPV2Bridger.CCTPBridgeRoute[](9);
        ...
        bridgeRoutes[5] = DaimoPayCCTPV2Bridger.CCTPBridgeRoute({
            domain: 26,
            bridgeTokenOut: 0x3600000000000000000000000000000000000000
        });
        // 1 -> 8453 USDC
        chainIds[6] = 8453;
        ...
        // 1 -> 59144 USDC
        chainIds[8] = 59144;
        bridgeRoutes[8] = DaimoPayCCTPV2Bridger.CCTPBridgeRoute({
            domain: 11,
