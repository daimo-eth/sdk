...
// @title DALegacyMeshBridgeRouteConstants
// @notice Auto-generated DA constants for Legacy Mesh bridge routes

// Return all DA Legacy Mesh bridge routes for the given source chain.
function getDALegacyMeshBridgeRoutes(
