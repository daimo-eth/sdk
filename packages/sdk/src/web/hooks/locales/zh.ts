...
export const zh: typeof en = {
  ...
  // withdrawal flow
  withdrawalAction: "提现",
  withdrawalDestinationQuestion: "您想提现到哪里？",
  withdrawalIdentifierPlaceholder: "EVM 地址、ENS 或 Solana 地址",
  withdrawalResolving: "正在解析…",
  withdrawalAddDestination: "添加新收款地址",
  withdrawalSavedDestinations: "已保存",
  withdrawalRemoveDestinationConfirm: "删除此收款地址？",
  withdrawalCancel: "取消",
  withdrawalRemove: "删除",
  withdrawalUnsupported: "不支持",
  withdrawalRemoveDestinationLabel: (identifier: string) =>
    `删除 ${identifier}`,
  withdrawalChooseStablecoin: "选择稳定币",
  withdrawalChooseNetwork: "选择网络",
  withdrawalReview: "确认提现",
  withdrawalRecipient: "收款人",
  withdrawalResolvedAddress: "已解析地址",
  withdrawalStablecoin: "稳定币",
  withdrawalNetwork: "网络",
  withdrawalSaveRoute: "下次保存此路线",
  withdrawalCreating: "正在创建提现…",
  withdrawalNotSubmitted: "提现未提交",
  withdrawalConfirm: "确认提现",
  withdrawalConfirmInWallet: "请在钱包中确认提现",
  withdrawalWaitingForTransfer: "等待您的转账",
  withdrawalInProgress: "提现处理中",
  withdrawalCompleted: "提现已完成",
  withdrawalRefunded: "提现已退款",
  withdrawalCancelled: "提现已取消",
  withdrawalRetry: "再次尝试提现",
  withdrawalExpired: "提现已过期",
  withdrawalSessionExpired: "此提现会话已过期。",
  withdrawalCompleteTransferInWallet: "请在钱包中完成转账以继续。",
  withdrawalFundsBeingDelivered: "已收到资金，正在发送。",
  withdrawalReachedDestination: "稳定币已到达所选收款地址。",
  withdrawalDeliveryFailedRefunded: "转账无法送达，已退款。",
  withdrawalNoTransferBeforeExpiry: "此会话过期前未检测到转账。",
  withdrawalAutoUpdate: "收到资金后，提现状态将自动更新。",
  withdrawalSolanaUnavailable: "暂不支持在 Solana 上提取 USDC。",
  withdrawalSavedRouteUnsupported: "此已保存路线不再受支持。",
  withdrawalInvalidIdentifier:
    "请输入有效的 EVM 地址、Solana 地址或 ENS 名称。",
  withdrawalInvalidEns: "请输入有效的 ENS 名称。",
  withdrawalSolanaNetworkRequired: "Solana 收款地址必须使用 Solana 网络。",
  withdrawalEvmNetworkRequired: "EVM 和 ENS 收款地址必须使用 EVM 网络。",
  withdrawalInitializationFailed: "无法初始化提现。",
  withdrawalHelp: "提现帮助",
  withdrawalExpiredHelp: "已过期的提现",
